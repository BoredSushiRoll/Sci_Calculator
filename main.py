...
root = Tk()
root.title("J.A.P.P") #Just Another Python Project
...
btnPM = Button(calc, text=chr(177), width=6,
               height=2, bg='dark green', font=('Arial', 20, 'bold'),
...
lblDisplay = Label(calc, text="Stiinta d-aia",
                   font=('Arial', 30, 'bold'),
                   bg='dark green', fg='white', justify=CENTER)
